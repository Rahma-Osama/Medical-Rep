...
import 'package:medical_rep/features/visit_flow/presentation/widgets/visit_location_card.dart';
...
import 'package:medical_rep/features/visit_flow/presentation/widgets/visit_tasks_card.dart';
...
class _ActiveVisitView extends StatelessWidget {
  ...
  void _onEndVisitPressed(BuildContext context, ActiveVisitState state) {
    if (state.elapsed.inSeconds < MIN_VISIT_TIME) {
